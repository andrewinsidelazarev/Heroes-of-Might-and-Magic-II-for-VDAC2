...
## Запись 2026-07-16: v020 reference — adventure UI assets + battle AI fix

По команде пользователя текущий успешно собранный build сохранён как новая опорная:
...
- формат продолжает серию project pre-releases: `Source`, `Build`, `Docs`, `Music`,
  `build.cmd`, `spgbld_vdac2.ini`, `PROJECT_MEMORY.md`, `REFERENCE.md`,
  `RELEASE_NOTES.md`;
- исходное состояние проекта соответствует Git-коммиту
  `0147c4920895829e4a33a2141f1cfcdd0a68f7ec`;
- adventure UI получил отдельный блок ассетов в хвосте RAM_G и повторную загрузку
  при входе на карту после города;
- фон списков героев/замков компонуется заранее, снижая построчную нагрузку FT812;
- исправлен вечный цикл выбора melee-цели Battle AI на разреженной adjacency mask;
- сохранены текущие инструменты воспроизведения и диагностики боёв/UI;
- локальные `.git`, `.claude`, `__pycache__`, временные каталоги сборки эмулятора,
  сырые игровые ресурсы и диагностические дампы в reference не копировались.
...
Build/verify зелёный: sjasmplus 0 errors/0 warnings, SPG собран, RAM_G calculator OK,
Core split p05=12288 bytes / p06=12210 bytes, RAM_DL max 7892/8192,
...
FF70DC6D04920F7E4057E1CBBAE6F82DC661EC83EB4DEF65A29678EA11B69B5C

Build\Core.bin
D0F48242A08F3FF79C4AE7DD784EE22238F05000243100BE6AF73EAF1DE3C359

Build\Core_p05.bin
9200CFC90A5A4806CAEAE0BFBA8D530721761ABA17D50DF9C23AAB92E16907D8

Build\Core_p06.bin
41318A408544CE97DF8CB94A7F1B6F4383250A41D718CD2FA3CC225A85297C84
```
